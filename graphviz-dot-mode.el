...
(defconst graphviz--attr-keywords
	`(
		...
		"dir" "distortion" "edge" "fixedsize" "group" "height" "layer"
		"layers" "len" "head" "lp" "ltail" "margin" "maxiter" "mclimit"
		"mindist" "minlen" "model" "node" "nodesep" "normalize" "nslimit"
...
(defconst graphviz-font-lock-components
	(cons (rx bow (or "node" "edge" "graph") eow) 'font-lock-type-face))
...
(defun eval-file ()
	...
	(user-error "Evaluated graphviz-dot-mode"))
